...
//
  ...
  final public void IOStmt() throws ParseException {
                 /*@bgen(jjtree) IOStmt */
  ASTIOStmt jjtn000 = new ASTIOStmt(this, JJTIOSTMT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
 ...
 /*@bgen(jjtree) NegExpr */
  ...
  final public void FctStmt() throws ParseException {
                  /*@bgen(jjtree) FctStmt */
  ASTFctStmt jjtn000 = new ASTFctStmt(this, JJTFCTSTMT);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
    try {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x60a00,0x60a00,0x60000,0x100000,0x0,0x0,0x0,0x18000000,0x18000000,0x60000000,0x60000000,0x80000000,0x10000000,0x0,0x400,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x10000,0x10000,0x0,0x0,0x3,0x3,0x4,0x0,0x0,0x0,0x0,0x0,0x0,0x190200,0x0,0x8000,};
   }
